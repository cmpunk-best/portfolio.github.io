...
<script>
      $('#h1').css({"background-color":"purple","color":"white"});
    $('#hmobile').css("color","white");
</script>
...
<div class="container-fluid">
            ...
            <div  id="fullsize" style="width:100%;margin-top:20%">
                <div class="row">
                 <div class="col-md-12 ">
            <div id="post"></div>
            ...
            <table>
                <tr>
                    <td>
                        <div id="erase" type="submit" data-toggle="modal" data-target="#myModal1" onclick="erase()"><pre class="btn btn-default btn-lg" style="border-radius:100%;width:60px;height:60px;padding:14px"><img src="/uploads/text.png" style="height:30px;width:30px"></button></div>
                    </td>
                    <td>
                        <div type="submit" data-toggle="modal" data-target="#myModal1" onclick="erase1()"><pre class="btn btn-default btn-lg" style="border-radius:100%;width:60px;height:60px;padding:14px"><img src="/uploads/camera.jpg" style="height:30px;width:30px"></button></div>
                    </td>
                    <td>
                        <div type="submit" data-toggle="modal" data-target="#myModal1" onclick="erase2()"><pre class="btn btn-default btn-lg" style="border-radius:100%;width:60px;height:60px;padding:14px"><img src="/uploads/video.jpg" style="height:30px;width:30px"></button></div>
                    </td>
                    <td>
                        <div type="submit" data-toggle="modal" data-target="#myModal1" onclick="erase3()"><pre class="btn btn-default btn-lg" style="border-radius:100%;width:60px;height:60px;padding:14px"><img src="/uploads/link.png" style="height:30px;width:30px"></button></div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div style="margin-left:10px;font-size:14px;font-family:Pangolin">Post</div>
                    </td>
                    <td>
                         <div style="margin-left:8px;font-size:14px;font-family:Pangolin">Photos</div>
                    </td>
                    <td>
                        <div style="margin-left:10px;font-size:15px;font-family:Pangolin">Videos</div>
                    </td>
                    <td>
                         <div style="margin-left:10px;font-size:15px;font-family:Pangolin">Links</div>
                    </td>
                </tr>
            </table>
            </blockquote>
...
html+='<div class="dropdown" >'+
    ...
    '<ul class="dropdown-menu">'+
      '<li style="font-size:18px"><a href="#"><span class="glyphicon glyphicon-flag"></span> Flag as inappropiate</a></li>'+
      '<li style="font-size:18px"><a id="delete" href="#" onclick="mydelete(\''+this['id']+'\',\''+this['user_id']+'\')"><i class="fa fa-trash-o fa-fw"></i> Delete this post</a></li>'+

    '</ul>'+
  '</div>';
  html+='</div></ul><br>'+'<div class="media-left"><img src="/uploads/'+this['url']+'" class="media-object img-rounded" style="width:60px;height:60px">';
        ...
        '</div><div id="wordwrapWITHWidth3" style="margin-left:1%"><h4>'+encodedMsg+'</h4>';

   if(this["imgpost"]!=''){
   html+='<img src="/uploads/'+this["imgpost"]+'" height="350px" class="img-rounded" width="320px" alt="postimg">';
...
'</video>';
   ...
   html+='</div><br><div id="godid" style="">';
   ...
   function toTitleCase(str)
{
    ...
    function mymodal(received,sename,url1){
                ...
                '<div class="modal-header">'+'<button type="button" class="close" data-dismiss="modal">&times;</button>'+
                '<h4 class="modal-title">Students who voted this post</h4>'+' </div>'+'<div class="modal-body">';
