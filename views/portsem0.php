...
<div class="container" >
  <div class="row">
    <nav class="col-sm-3" id="myScrollspy" >
      ...
      <ul class="nav nav-pills nav-stacked" data-spy="affix" data-offset-top="305" >
        ...
        <li class="active"><a href="#" class="btn btn-default">Year-1</a></li>
        ...
        <?php endforeach?>
        <li class=""><a href="portsem_.php" class="btn btn-default">Year-2</a></li>
  ...
  <?php  $count=0;?>
     ...
     <?php $count++; ?>
      <div id="section<?= $count?>" style="border-radius:10px;padding:30px;color: #000; background-color: #fff;border:1px solid black7">
        ...
        <p>
          <table  style="font-size:20px;margin-left:50px">
            ...
            <tr>
              ...
              <td>
                <a href="#" target="_blank" style="color:#fff"><?= $sub["link"]?></a><img src="/uploads/new2.gif" style="width:50px;height:40px">
              </td>
              <td>
                <?= $sub["year"]?>
              </td>
