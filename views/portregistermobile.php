...
<ul class="nav-mobile navbar-fixed-top" >
  ...
  <div class="jumbotron" style="background:white !important;border:1px solid white">
    <div class="row">
...
<h1 style="font-family:Pangolin">Create Account</h1>
<hr style="display: block;
    ...
    <form data-toggle="validator" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" role="form">
        <fieldset>
              ...
              <div class="form-group ">
                  <label for="inputPassword" class="control-label">Roll No.</label><?php echo $GLOBALS['rollErr'];?></span>
                    <input type=""  data-minlength="6" autocomplete="off"class="form-control" name="roll" id="inputPassword1" placeholder="XXXXXX" required>
              ...
              <div class="form-group">
                ...
                <div class="form-inline row">
                  <div class="form-group col-sm-6">
                    <input type="password" data-minlength="6"  autocomplete="off"class="form-control" name="password" id="inputPassword" placeholder="Password" required>
                    <div class="help-block">Minimum of 6 characters</div>
                  </div>
                  <div class="form-group col-sm-6">
                    <input type="password" class="form-control" autocomplete="off"id="inputPasswordConfirm" name="confirmation" data-match="#inputPassword" data-match-error="Whoops, these don't match" placeholder="Confirm" required>
                    <div class="help-block with-errors"></div>
                  </div>
                </div>
              </div>
