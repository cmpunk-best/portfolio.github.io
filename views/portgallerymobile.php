...
<link rel="stylesheet" href="https://cdn.rawgit.com/konpa/devicon/df6431e323547add1b4cf45992913f15286456d3/devicon.min.css">
    <script>
    $('#h3').css("background","purple");
    $('#gmobile').css("color","white");
function erase1(){
        $('#post').empty();
...
<div class="col-md-12">
            <div id="full-size" style="background: white;margin-top:30px;height:60%" >
...
<div class="col-xs-18 col-sm-6 col-md-3">
          <div class="thumbnail">
            <img src="/uploads/<?= $rows[$i]["imgurl"]?>" alt="" style="width:100%;height:250px">
              <div class="caption">
  ...
  <li  ><!--TODO :cant hit set before selecting-->
...
<?php $checker++;?>
    <?php endfor?>
      ...
      <div class="row">
        <div id="waitani" style="position: absolute;top:60%;left:35%;width:88px;height:85px;z-index: 999;visibility: hidden;" class="col-md-2 col-md-offset-5"><img alt="ajax_big_indicator (3K)" src="/uploads/Rolling.gif" height="80" width="80" /></div>
      </div>
      <div id="txtHint1" class="row">
        <div class="row">
        <div id="waitani1" style="position: absolute;top:60%;left:35%;width:88px;height:85px;z-index: 999;visibility: hidden;" class="col-md-2 col-md-offset-5"><img alt="ajax_big_indicator (3K)" src="/uploads/Rolling.gif" height="80" width="80" /></div>
      </div>
      </div>
