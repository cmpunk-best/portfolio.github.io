<?php
     ...
     */
    function apologize($message,$path,$message2)
    {
        render("apology.php", ["message" => $message,"path"=>$path,"message2"=>$message2]);
    }
     ...
     * to browser.
     */
     function apologize1($message,$message2)
    {
        render("apology1.php", ["message" => $message,"message2"=>$message2]);
    }
    function dump()
    {
